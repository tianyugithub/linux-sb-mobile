...
**首页**
版块切换与排序（新评论、新帖子、精华、抽奖、发卡、足迹、申精）；帖子列表的关键词与版块屏蔽；每日热帖。

**帖子**
正文渲染支持富文本、代码高亮、视频、图片与链接卡片；楼层与盖楼视图；点赞打赏、收藏、淘帖专辑、举报；
精华申请与竞猜；抽奖帖参与。

**编辑**
Markdown 与所见即所得双模式编辑器，内核运行于 WebView；表情库、图片上传与批量插图、全屏编辑、草稿保留。

**账号**
登录（含人机验证）、注册与找回密码入口；签到中心（连续天数、累计次数、签到记录）；积分流水与明细；
称号中心与称号合成；榜单、邀请码、身份认证。

**其他**
私信（支持引用）、通知中心、搜索（帖子、用户、版块）、用户主页；
设置项包括字号、深浅色、代码主题与字体、图片托管、帖子列表屏蔽规则，另有「关于项目」页
（版本信息、项目地址与检查更新）。
